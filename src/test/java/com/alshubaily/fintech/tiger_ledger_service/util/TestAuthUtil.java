...
public class TestAuthUtil {
    ...
    public static HttpRequestUtil.RequestResult login(
            LoginRequest loginRequest, CloseableHttpClient client) throws Exception {
    ...
    public static String GetAuthToken(String userIdentifier, CloseableHttpClient client)
            throws Exception {
        HttpRequestUtil.RequestResult resp =
                login(new LoginRequest(userIdentifier, userIdentifier, userIdentifier), client);
        return objectMapper.readValue(resp.body(), LoginResponse.class).token();
    }

    public static String SignUpAndGetToken(String userIdentifier, CloseableHttpClient client)
            throws Exception {
