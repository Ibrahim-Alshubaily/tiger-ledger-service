...
public class TestAccountUtil {
    ...
    public static BigInteger CreateAccount(String token, CloseableHttpClient httpClient)
            throws Exception {
        // Create Account
    ...
    public static HttpRequestUtil.RequestResult GetAccountResponse(
            String accountId, String token, CloseableHttpClient httpClient) throws Exception {
    ...
    public static GetAccountResponse GetAccount(
            String accountId, String token, CloseableHttpClient httpClient) throws Exception {
    ...
    public static GetAccountResponse[] GetAccounts(String token, CloseableHttpClient httpClient)
            throws Exception {
